...
import { COURSE_PRICE, fetchCourseBySlug, fetchLessons } from "@/lib/queries";
      ...
      <section className="border-b border-border bg-surface">
        <div className="container-page py-14">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3 border-t border-border pt-6">
            ...
            <span className="text-sm text-muted-foreground">One-time course fee</span>
          </div>
            ...
            {enrollment ? (
              ...
              <>
                <p className="mt-3 text-sm text-ink">
                  Course fee: <span className="font-semibold text-foreground">{COURSE_PRICE}</span>.
                  Enrolment gives immediate access to all modules and the course assessment.
                </p>
                <button
                  type="button"
